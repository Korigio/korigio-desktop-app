    ...
    match table {
        ...
        "repairs" => dump_simple(
            ...
            "SELECT id, repair_number, customer_id, device_id, company_id, assigned_to_staff_id,
                    ...
                    estimate_gross_cents, ready_at, collected_at, created_at, updated_at,
                    archived_at, hlc_wall_ms, hlc_counter, origin_device_id,
                    updated_by_staff_id, deleted_at
             FROM repairs",
            |row| {
                Ok(json!({
                    ...
                    "estimateBaseCents": row.get::<_, Option<i64>>(15)?,
                    "estimateTaxRateBps": row.get::<_, Option<i64>>(16)?,
                    "estimateTaxCents": row.get::<_, Option<i64>>(17)?,
                    "estimateGrossCents": row.get::<_, Option<i64>>(18)?,
                    "readyAt": row.get::<_, Option<String>>(19)?,
                    "collectedAt": row.get::<_, Option<String>>(20)?,
                    "createdAt": row.get::<_, String>(21)?,
                    "updatedAt": row.get::<_, String>(22)?,
                    "archivedAt": row.get::<_, Option<String>>(23)?,
                    "hlcWallMs": row.get::<_, i64>(24)?,
                    "hlcCounter": row.get::<_, i64>(25)?,
                    "originDeviceId": row.get::<_, String>(26)?,
                    "updatedByStaffId": row.get::<_, Option<String>>(27)?,
                    "deletedAt": row.get::<_, Option<String>>(28)?,
                }))
            },
        ),
